      ...
      <div className="max-h-[80vh] overflow-y-auto">
        ...
        <div className="flex flex-col items-center mb-6 pb-6 border-b border-gray-200">
          <div className="relative group">
            <div className="w-24 h-24 rounded-full overflow-hidden bg-gradient-to-br from-[#1ABC9C] to-[#16A085] flex items-center justify-center">
              {getProfileImageUrl() ? (
                <img
            ...
            <button
              ...
              className="absolute bottom-0 right-0 bg-[#1ABC9C] hover:bg-[#16A085] text-white p-2 rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 disabled:opacity-50"
            >
              {imageLoading ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <h3 className="text-md font-semibold text-[#2C3E50] mb-3">Personal Information</h3>
          ...
          <div className="pt-4 border-t border-gray-200">
            <h3 className="text-md font-semibold text-[#2C3E50] mb-3">Change Password</h3>
